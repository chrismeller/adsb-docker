...
# extracted from https://github.com/wiedehopf/adsb-scripts/blob/master/autogain-install.sh
# we leave most of the if/else logic intact just to make it easier to keep this up-to-date
